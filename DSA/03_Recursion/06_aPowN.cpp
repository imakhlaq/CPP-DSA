...
int powerN(int a, int n) {
   ...
   // before you were caling function multiple time that canbe reduce just call
   // the power function with the == power(a,n/2) and the value it gives in a
   // varible and for odd do a*x*X -===- for even do x*x and just return it
